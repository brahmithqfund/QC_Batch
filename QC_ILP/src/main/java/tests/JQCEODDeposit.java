			...
			int lastrow=TestData.getLastRow("EOD_Deposit");
				...
				{		
					   ...
					   Thread.sleep(5000);
						...
						driver.findElement(By.name("drawerDeassignRequestBean.password")).sendKeys(PIN);
						test.log(LogStatus.PASS, "Banker PIN# is enetered as "+PIN);	
						...
						driver.findElement(By.name("drawerDeassignRequestBean.password")).sendKeys(PIN);	
						test.log(LogStatus.PASS, "Passwrod entered as  "+PIN);
						driver.findElement(By.name("drawerdeassign")).click();
...
// Switchign to CSR						
		...
		test.log(LogStatus.FAIL,"EODDeposit process is initiated again due to Application sync issue");
