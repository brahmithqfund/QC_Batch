								...
								// int business_date2_int = Integer.parseInt(business_date2);
									...
									Thread.sleep(3000);
										...
										if (business_date2_int  <=15) {
											...
											String expected_date = (business_date1_int+1) + "/" + 1 + "/"
													+ business_date3_int;
											String expected_date2 = "0" + (business_date1_int+1) + "/" + "0" + 1 + "/"
													+ business_date3_int;
											String expected_date3 = (business_date1_int+1) + "/" + "0" + 1 + "/"
													+ business_date3_int;
											String expected_date4 = "0" + (business_date1_int+1) + "/" + 1 + "/"
													+ business_date3_int;
							...
							if ((month_dispay == 11)) {
								...
								//int business_date2_int = Integer.parseInt(business_date2);
										...
										if (business_date2_int  <=14) {
											...
											if(business_date2_int==expected_day_int)
											{
												String expected_date = (1) + "/" + 15 + "/"
														+ (business_date3_int+1);
												String expected_date2 = (1) + "/" + 15 + "/"
														+ (business_date3_int+1);
												String expected_date3 = (1) + "/" + 15 + "/"
														+ (business_date3_int+1);
												String expected_date4 = (1) + "/" + 15 + "/"
														+ (business_date3_int+1);
