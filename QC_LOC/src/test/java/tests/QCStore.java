...
//Ratikanta Scenarios
		...
		public static void RQC_LOC_ManualDefault_Txn_Testdata() throws Exception {
			try {
				test = reports.startTest(("QC_LOC_ManualDefault_Txn"),
				...
				String screenshotPath = getScreenhot(driver, "QC_LOC_ManualDefault_Txn");
		...
		public static void RQC_LOC_Deposit_Return_ManualDefault_Txn_Testdata() throws Exception {
			try {
				test = reports.startTest(("QC_LOC_Deposit_Return_ManualDefault_Txn"),
		...
		public static void RQC_LOC_Deposit_Return_2ndDeposit_Clear_3rdDeposit_Return_Default_Txn_Testdata()
				throws Exception {
			try {
				test = reports.startTest(("QC_LOC_Deposit_Return_2ndDeposit_Clear_3rdDeposit_Return_Default_Txn"),
		...
		public static void RQC_LOC_2missedPayment_Default_EOD_Txn_Testdata() throws Exception {
			try {
				test = reports.startTest(
						("New LOC_Deposit_Return_2nd Deposit_Clear_3rd Deposit_Return_Default(EOD/Auto EOD)"),
		...
		public static void RQC_LOC_Default_DefaultPayment_Return_Txn_Testdata() throws Exception {
			try {
				test = reports.startTest(("QC_LOC_Default_DefaultPayment_Return_Txn"),
		...
		public static void RQC_LOC_Default_PartialDefaultPayment_FullDefaultPayment_Txn_Testdata() throws Exception {
			try {
				test = reports.startTest(("QC_LOC_Default_PartialDefaultPayment_FullDefaultPayment_Txn"),
		...
		public static void RQC_LOC_PayOff_Agestore180days_AutoClosure_Txn_Testdata() throws Exception {
			try {
				test = reports.startTest(("New LOC_Payoff_Age the store to 180 daysAuto Closure"),
		...
		public static void RQC_LOC_ManualDefault_EOD_Txn_Testdata() throws Exception {
			try {
				test = reports.startTest(("QC_LOC_ManualDefault_EOD_Txn"),
				...
				System.out.println("under catch of Test" + e);
				String screenshotPath = getScreenhot(driver, "QC_LOC_ManualDefault_EOD_Txn");
				test.log(LogStatus.INFO, test.addScreenCapture(screenshotPath));
				test.log(LogStatus.ERROR, "Unable to start scenarios ");
		...
		public static void RQC_LOC_Deposit_Return_2ndDeposit_Return_Default_Txn_Testdata() throws Exception {
			try {
				test = reports.startTest(("QC_LOC_Deposit_Return_2ndDeposit_Return_Default_Txn"),
				...
				System.out.println("under catch of Test" + e);
				String screenshotPath = getScreenhot(driver, "QC_LOC_Deposit_Return_2ndDeposit_Return_Default_Txn");
				test.log(LogStatus.INFO, test.addScreenCapture(screenshotPath));
				test.log(LogStatus.ERROR, "Unable to start scenarios ");
	...
	// Anoop scenarios
		...
		@Test(priority = 426, enabled = true, groups = { "EOD3" })
		...
		@Test(priority = 423, enabled = true, groups = { "EOD3" })
		...
		@Test(priority = 422, enabled = true, groups = { "EOD3" })
		...
		@Test(priority = 421, enabled = true, groups = { "EOD2" })
		...
		@Test(priority = 420, enabled = true, groups = { "EOD2" })
		...
		@Test(priority = 419, enabled = true, groups = { "EOD2" })
		...
		@Test(priority = 418, enabled = true, groups = { "EOD2" })
		...
		@Test(priority = 417, enabled = true, groups = { "EOD1" })
		...
		@Test(priority = 416, enabled = true, groups = { "EOD1" })
		...
		@Test(priority = 415, enabled = true, groups = { "EOD1" })
		...
		@Test(priority = 414, enabled = true, groups = { "EOD1" })
		...
		@Test(priority = 413, enabled = true, groups = { "EOD1" })
		...
		@Test(priority = 412, enabled = true, groups = { "EOD1" })
